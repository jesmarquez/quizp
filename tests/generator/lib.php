 ...
 */
class mod_quizp_generator extends testing_module_generator {
    ...
    public function create_instance($record = null, array $options = null) {
        ...
        $defaultquizpsettings = array(
            'timeopen'               => 0,
            'timeclose'              => 0,
            'preferredbehaviour'     => 'deferredfeedback',
            'attempts'               => 0,
            'attemptonlast'          => 0,
            'grademethod'            => QUIZP_GRADEHIGHEST,
            'decimalpoints'          => 2,
            ...
            'showuserpicture'        => 0,
            'showblocks'             => 0,
            'navmethod'              => QUIZP_NAVMETHOD_FREE,
        );

        foreach ($defaultquizpsettings as $name => $value) {
