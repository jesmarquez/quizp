@mod @mod_quizp
Feature: Set a quizp to be marked complete when the student uses all attempts allowed
  In order to ensure a student has learned the material before being marked complete
  As a teacher
  I need to set a quizp to complete when the student receives a passing grade, or completed_fail if they use all attempts without passing
  ...
  Background:
    ...
    And the following "activities" exist:
      ...
      | quizp       | Test quizp name | C1     | quizp1    | 2        | 5.00      | 2          | 1                           |
