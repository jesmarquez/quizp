@mod @mod_quizp
Feature: Edit quizp page - remove questions
  ...
  Scenario: Delete questions by clicking on the delete icon.
    ...
    And I should see "This quizp is open"

    # Delete last question in last page. Page contains multiple questions
    When I delete "Question C" in the quizp by clicking the delete icon
    Then I should see "Question A" on quizp page "1"
    And I should see "Question B" on quizp page "1"
    And I should not see "Question C" on quizp page "2"
    ...
    Then I should see "Question B" on quizp page "2"
    And the "Remove" page break icon after question "Question A" should exist
    And I delete "Question A" in the quizp by clicking the delete icon
    Then I should see "Question B" on quizp page "1"
    And I should not see "Page 2"
    And I should not see "Question A" on quizp page "2"
  ...
  @javascript
  Scenario: Can delete the last question in a quizp.
    Given the following "questions" exist:
      | questioncategory | qtype     | name       | questiontext        |
      | Test questions   | truefalse | Question A | This is question 01 |
    And quizp "Quiz 1" contains the following questions:
