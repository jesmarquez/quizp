@mod @mod_quizp
Feature: Edit quizp page - section headings
  In order to build a quizp laid out in sections the way I want
  As a teacher
  ...
  @javascript
  Scenario: We have a quizp with one default section
    Given the following "activities" exist:
      | activity   | name   | intro              | course | idnumber |
      | quizp       | Quiz 1 | Quiz 1 description | C1     | quizp1    |
  ...
  Scenario: Modify the default section headings
    ...
    And I follow "Quiz 1"
    And I follow "Edit quizp"
    And I change quizp section heading "" to "This is section one"
 ...
 @javascript
  Scenario: Modify section headings
    ...
    And quizp "Quiz 1" contains the following questions:
      ...
      | TF3      | 3    |
      | TF4      | 3    |
    And quizp "Quiz 1" contains the following sections:
    ...
    And I follow "Edit quizp"
    And I change quizp section heading "" to "This is section one"
    And I change quizp section heading "Heading 2" to "This is section two"
    Then I should see "This is section one"
  ...
  Scenario: The edit-icon tool-tips are updated when a section is edited
    ...
    And I follow "Quiz 1"
    And I follow "Edit quizp"
    And I change quizp section heading "Heading 2" to "Edited heading"
  ...
  Scenario: Moving a question up from section 3 to the first section.
    ...
    And I follow "Quiz 1"
    And I follow "Edit quizp"
    And I move "TF5" to "After Question 2" in the quizp by clicking the move icon
    Then I should see "TF5" on quizp page "2"
  ...
  Scenario: moving a question down from the first section to the second section.
    ...
    And I follow "Quiz 1"
    And I follow "Edit quizp"
    And I move "TF1" to "After Question 3" in the quizp by clicking the move icon
    Then I should see "TF1" on quizp page "2"

  @javascript
  Scenario: I should not see a delete icon for the first section in the quizp.
    Given the following "activities" exist:
      | activity   | name   | intro              | course | idnumber |
      | quizp       | Quiz 1 | Quiz 1 description | C1     | quizp1    |
    And the following "questions" exist:
  ...
  Scenario: Turn shuffling on for a section
    ...
    And I follow "Quiz 1"
    And I follow "Edit quizp"
    And I click on shuffle for section "Heading 1" on the quizp edit page
    And I click on shuffle for section "Heading 2" on the quizp edit page
    Then shuffle for section "Heading 1" should be "On" on the quizp edit page
    And shuffle for section "Heading 2" should be "On" on the quizp edit page
  ...
  Scenario: Turn shuffling off for a section
    ...
    And I click on shuffle for section "Heading 1" on the quizp edit page
    And I click on shuffle for section "Heading 2" on the quizp edit page
    Then shuffle for section "Heading 1" should be "Off" on the quizp edit page
    And shuffle for section "Heading 2" should be "Off" on the quizp edit page
    And I reload the page
    And shuffle for section "Heading 1" should be "Off" on the quizp edit page
    And shuffle for section "Heading 2" should be "Off" on the quizp edit page
  ...
  Scenario: Verify sections are added in the right place afte ajax changes
    ...
    And I open the "Page 2" add to quizp menu
