...
/**
 * Implementaton of the quizpaccess_safebrowser plugin.
 *
 * @package    quizpaccess
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizpaccess_safebrowser extends quizp_access_rule_base {

    public static function make(quizp $quizpobj, $timenow, $canignoretimelimits) {

        if ($quizpobj->get_quizp()->browsersecurity !== 'safebrowser') {
            return null;
        }
    ...
    public function prevent_access() {
        if (!$this->check_safe_browser()) {
            return get_string('safebrowsererror', 'quizpaccess_safebrowser');
        } else {
            return false;
        }
    }
    ...
    public function description() {
        return get_string('safebrowsernotice', 'quizpaccess_safebrowser');
    }
    ...
    public static function get_browser_security_choices() {
        ...
        return array('safebrowser' =>
                get_string('requiresafeexambrowser', 'quizpaccess_safebrowser'));
    }
}
