...
/**
 * Defines the Moodle forum used to add random questions to the quizp.
 *
 * @package   mod_quizp
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizp_add_random_form extends moodleform {
    ...
    protected function definition() {
        ...
        $mform->addElement('header', 'categoryheader',
                get_string('randomfromexistingcategory', 'quizp'));
        ...
        $mform->addElement('checkbox', 'includesubcategories', '', get_string('recurse', 'quizp'));

        $mform->addElement('select', 'numbertoadd', get_string('randomnumber', 'quizp'),
                $this->get_number_of_questions_to_add_choices());

        $mform->addElement('submit', 'existingcategory', get_string('addrandomquestion', 'quizp'));

        // Random from a new category section.
        $mform->addElement('header', 'categoryheader',
                get_string('randomquestionusinganewcategory', 'quizp'));
        ...
        $mform->addElement('submit', 'newcategory',
                get_string('createcategoryandaddrandomquestion', 'quizp'));
