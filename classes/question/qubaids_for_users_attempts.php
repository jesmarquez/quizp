...
/**
 * A {@link qubaid_condition} representing all the attempts by one user at a given quizp.
 *
 * @package   mod_quizp
 * @category  question
...
class qubaids_for_users_attempts extends \qubaid_join {
     ...
     * Constructor.
     *
     * This takes the same arguments as {@link quizp_get_user_attempts()}.
     *
     ...
     */
    public function __construct($quizpid, $userid, $status = 'finished', $includepreviews = false) {
        $where = 'quizpa.quizp = :quizpaquizp AND quizpa.userid = :userid';
        $params = array('quizpaquizp' => $quizpid, 'userid' => $userid);
