...
/**
 * Admin settings class for the quizp review options.
 *
 * @package   mod_quizp
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_quizp_admin_review_setting extends admin_setting {
    /**
     * @var integer should match the constants defined in
     * {@link mod_quizp_display_options}. Copied for performance reasons.
     */
    ...
    /**
     * This should match {@link mod_quizp_mod_form::$reviewfields} but copied
     * here because generating the admin tree needs to be fast.
     * @return array
     */
    public static function fields() {
        return array(
            'attempt'          => get_string('theattempt', 'quizp'),
            ...
            'overallfeedback'  => get_string('overallfeedback', 'quizp'),
        );
    }
    ...
    protected static function times() {
        return array(
            self::DURING            => get_string('reviewduring', 'quizp'),
            self::IMMEDIATELY_AFTER => get_string('reviewimmediately', 'quizp'),
            self::LATER_WHILE_OPEN  => get_string('reviewopen', 'quizp'),
            self::AFTER_CLOSE       => get_string('reviewclosed', 'quizp'),
        );
    }
    ...
    public function output_html($data, $query = '') {
        ...
        return format_admin_setting($this, $this->visiblename, $return,
                $this->description, true, '', get_string('everythingon', 'quizp'), $query);
    }
}
