...
/**
 * The mod_quizp attempt became overdue event.
 *
 * @package    mod_quizp
...
/**
 * The mod_quizp attempt became overdue event class.
 *
...
class attempt_becameoverdue extends \core\event\base {
    ...
    public function get_description() {
        return "The quizp attempt with id '$this->objectid' belonging to the quizp with course module id '$this->contextinstanceid' " .
    ...
    public static function get_name() {
        return get_string('eventquizpattempttimelimitexceeded', 'mod_quizp');
    }
