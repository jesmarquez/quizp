...
/**
 * The mod_quizp question manually graded event.
 *
 * @package    core
...
/**
 * The mod_quizp question manually graded event class.
 *
...
class question_manually_graded extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquestionmanuallygraded', 'mod_quizp');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' manually graded the question with id '$this->objectid' for the attempt " .
            "with id '{$this->other['attemptid']}' for the quizp with course module id '$this->contextinstanceid'.";
    }
    ...
    public function get_url() {
        return new \moodle_url('/mod/quizp/comment.php', array('attempt' => $this->other['attemptid'],
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'quizp', 'manualgrade', 'comment.php?attempt=' . $this->other['attemptid'] .
            '&slot=' . $this->other['slot'], $this->other['quizpid'], $this->contextinstanceid);
    }
    ...
    public static function get_other_mapping() {
        ...
        $othermapped['attemptid'] = array('db' => 'quizp_attempts', 'restore' => 'quizp_attempt');
