...
/**
 * The mod_quizp attempt viewed event.
 *
 * @package    mod_quizp
...
/**
 * The mod_quizp attempt viewed event class.
 *
...
class attempt_viewed extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptviewed', 'mod_quizp');
    }
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'quizp', 'continue attempt', 'review.php?attempt=' . $this->objectid,
