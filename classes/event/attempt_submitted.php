...
/**
 * The mod_quizp attempt submitted event.
 *
 * @package    mod_quizp
...
/**
 * The mod_quizp attempt submitted event class.
 *
...
class attempt_submitted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventquizpattemptsubmitted', 'mod_quizp');
    }
    ...
    static public function get_legacy_eventname() {
        return 'quizp_attempt_submitted';
    }
