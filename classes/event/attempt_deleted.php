...
/**
 * The mod_quizp attempt deleted event.
 *
 * @package    mod_quizp
...
/**
 * The mod_quizp attempt deleted event class.
 *
...
class attempt_deleted extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('eventattemptdeleted', 'mod_quizp');
    }
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the attempt with id '$this->objectid' belonging to the quizp " .
    ...
    protected function get_legacy_logdata() {
        return array($this->courseid, 'quizp', 'delete attempt', 'report.php?id=' . $this->contextinstanceid,
