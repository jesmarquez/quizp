...
/**
 * Strings for component 'quizp', language 'en', branch 'MOODLE_20_STABLE'
 *
 * @package   mod_quizp
...
$string['accessnoticesheader'] = 'You can preview this quizp, but if this were a real attempt, you would be blocked because:';
$string['action'] = 'Action';
$string['activityoverview'] = 'You have quizpzes that are due';
$string['adaptive'] = 'Adaptive mode';
$string['adaptive_help'] = 'If enabled, multiple responses to a question are allowed within the same attempt at the quizp. So for example if a response is marked as incorrect, the student will be allowed to try again immediately. However, depending on the "Apply penalties" setting, a penalty will usually be subtracted for each wrong attempt.';
$string['add'] = 'Add';
$string['addaquestion'] = 'a new question';
$string['addasection'] = 'a new section heading';
$string['addarandomquestion'] = 'a random question';
$string['addarandomquestion_help'] = 'When a random question is added, it results in a randomly-chosen question from the category being inserted into the quizp. This means that different students are likely to get a different selection of questions, and when a quizp allows multiple attempts then each attempt is likely to contain a new selection of questions.';
...
$string['addingquestions'] = '<p>This side of the page is where you manage your database of questions. Questions are stored in categories to help you keep them organised, and can be used by any quizp in your course or even other courses if you choose to \'publish\' them.</p>
<p>After you select or create a question category you will be able to create or edit questions. You can select any of these questions to add to your quizp over on the other side of this page.</p>';
...
$string['addquestionstoquizp'] = 'Add questions to current quizp';
...
$string['addrandomquestiontoquizp'] = 'Add a random question to quizp {$a}';
$string['addrandom1'] = '<< Add';
$string['addrandom2'] = 'random questions';
$string['addselectedquestionstoquizp'] = 'Add selected questions to the quizp';
$string['addselectedtoquizp'] = 'Add selected to quizp';
$string['addtoquizp'] = 'Add to quizp';
...
$string['attempterror'] = 'You are not allowed to attempt this quizp at this time because: {$a}';
$string['attemptfirst'] = 'First attempt';
$string['attemptincomplete'] = 'That attempt (by {$a}) is not yet completed.';
$string['attemptlast'] = 'Last attempt';
$string['attemptnumber'] = 'Attempt';
$string['attemptquizpnow'] = 'Attempt quizp now';
...
* The quizp will only start if the student has a JavaScript-enabled web-browser
* The quizp appears in a full screen popup window that covers all the other windows and has no navigation controls
...
$string['cannoteditafterattempts'] = 'You cannot add or remove questions because this quizp has been attempted. ({$a})';
...
$string['cannotsetgrade'] = 'Could not set a new maximum grade for the quizp';
$string['cannotsetsumgrades'] = 'Failed to set sumgrades';
$string['cannotstartgradesmismatch'] = 'Cannot start an attempt at this quizp. The quizp is set to be graded out of {$a->grade}, but none of the questions in the quizp have a grade. This can be fixed on the \'Edit quizp\' page.';
$string['cannotstartmissingquestion'] = 'Cannot start an attempt at this quizp. The quizp definition includes a question that does not exist.';
$string['cannotstartnoquestions'] = 'Cannot start an attempt at this quizp. The quizp has not been set up yet. No questions have been added.';
$string['cannotwrite'] = 'Cannot write to export file ({$a})';
$string['canredoquestions'] = 'Allow redo within an attempt';
$string['canredoquestions_desc'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire quizp attempt and start another one. This option is mainly useful for practice quizpzes.
...
$string['canredoquestions_help'] = 'If enabled, then when students have finished attempting particular question, they will see a Redo question button. This allows them to attempt another version of the same question, without having to submit the entire quizp attempt and start another one. This option is mainly useful for practice quizpzes.
...
$string['closebeforeopen'] = 'Could not update the quizp. You have specified a close date before the open date.';
...
$string['completionattemptsexhausted_help'] = 'Mark quizp complete when the student has exhausted the maximum number of attempts.';
$string['configadaptive'] = 'If you choose Yes for this option then the student will be allowed multiple responses to a question even within the same attempt at the quizp.';
$string['configattemptsallowed'] = 'Restriction on the number of attempts students are allowed at the quizp.';
$string['configdecimaldigits'] = 'Number of digits that should be shown after the decimal point when displaying grades.';
$string['configdecimalplaces'] = 'Number of digits that should be shown after the decimal point when displaying grades for the quizp.';
...
$string['configdelay1'] = 'If you set a time delay, then a student has to wait for that time before they can attempt a quizp after the first attempt.';
...
$string['configgrademethod'] = 'When multiple attempts are allowed, which method should be used to calculate the student\'s final grade for the quizp.';
$string['configintro'] = 'The values you set here define the default values that are used in the settings form when you create a new quizp. You can also configure which quizp settings are considered advanced.';
$string['configmaximumgrade'] = 'The default grade that the quizp grade is scaled to be out of.';
$string['confignewpageevery'] = 'When adding questions to the quizp page breaks will automatically be inserted according to the setting you choose here.';
...
$string['configoutcomesadvanced'] = 'If this option is turned on, then the Outcomes on the quizp editing form are advanced settings.';
$string['configpenaltyscheme'] = 'Penalty subtracted for each wrong response in adaptive mode.';
$string['configpopup'] = 'Force the attempt to open in a popup window, and use JavaScript tricks to try to restrict copy and paste, etc. during quizp attempts.';
$string['configrequirepassword'] = 'Students must enter this password before they can attempt the quizp.';
$string['configrequiresubnet'] = 'Students can only attempt the quizp from these computers.';
$string['configreviewoptions'] = 'These options control what information users can see when they review a quizp attempt or look at the quizp reports.';
$string['configshowblocks'] = 'Show blocks during quizp attempts.';
$string['configshowuserpicture'] = 'Show the user\'s picture on screen during attempts.';
$string['configshufflewithin'] = 'If you enable this option, then the parts making up the individual questions will be randomly shuffled each time a student starts an attempt at this quizp, provided the option is also enabled in the question settings.';
$string['configtimelimit'] = 'Default time limit for quizpzes in minutes. 0 mean no time limit.';
$string['configtimelimitsec'] = 'Default time limit for quizpzes in seconds. 0 mean no time limit.';
...
$string['confirmstartattempttimelimit'] = 'This quizp has a time limit and is limited to {$a} attempt(s). You are about to start a new attempt.  Do you wish to proceed?';
$string['confirmstarttimelimit'] = 'The quizp has a time limit. Are you sure that you wish to start?';
...
$string['continueattemptquizp'] = 'Continue the last attempt';
...
$string['countdownfinished'] = 'The quizp is closing, you should submit your answers now.';
$string['countdowntenminutes'] = 'The quizp will be closing in ten minutes.';
...
$string['createmultiple'] = 'Add several random questions to quizp';
$string['createnewquestion'] = 'Create new question';
$string['createquestionandadd'] = 'Create a new question and add it to the quizp.';
...
$string['delaylater_help'] = 'If enabled, a student must wait for the specified time to elapse before attempting the quizp a third time and any subsequent times.';
$string['delay1'] = 'Time delay between first and second attempt';
$string['delay1st2nd'] = 'Enforced delay between 1st and 2nd attempts';
$string['delay1st2nd_help'] = 'If enabled, a student must wait for the specified time to elapse before being able to attempt the quizp a second time.';
...
$string['downloadextra'] = '(file is also stored in the course files in the /backupdata/quizp folder)';
...
$string['eachattemptbuildsonthelast_help'] = 'If multiple attempts are allowed and this setting is enabled, each new quizp attempt will contain the results of the previous attempt. This allows a quizp to be completed over several attempts.';
$string['editcategories'] = 'Edit categories';
$string['editcategory'] = 'Edit category';
$string['editcatquestions'] = 'Edit category questions';
$string['editingquestion'] = 'Editing a question';
$string['editingquizp'] = 'Editing quizp';
$string['editingquizp_help'] = 'When creating a quizp, the main concepts are:

* The quizp, containing questions over one or more pages
* The question bank, which stores copies of all questions organised into categories
* Random questions -  A student gets different questions each time they attempt the quizp and different students can get different questions';
$string['editingquizp_link'] = 'mod/quizp/edit';
$string['editingquizpx'] = 'Editing quizp: {$a}';
...
$string['editquizp'] = 'Edit quizp';
$string['editquizpquestions'] = 'Edit quizp questions';
...
You can access this quizp at {$a->quizpurl}.';
$string['emailconfirmsmall'] = 'Thank you for submitting your answers to \'{$a->quizpname}\'';
$string['emailconfirmsubject'] = 'Submission confirmation: {$a->quizpname}';
$string['emailnotifybody'] = 'Dear {$a->username},

{$a->studentname} has completed
\'{$a->quizpname}\' ({$a->quizpurl})
in course \'{$a->coursename}\'

You can review this attempt at {$a->quizpreviewurl}.';
$string['emailnotifysmall'] = '{$a->studentname} has completed {$a->quizpname}. See {$a->quizpreviewurl}';
$string['emailnotifysubject'] = '{$a->studentname} has completed {$a->quizpname}';
$string['emailoverduebody'] = 'Dear {$a->studentname},

You started an attempt at \'{$a->quizpname}\'
...
$string['emailoverduesmall'] = 'You did not submit your attempt at {$a->quizpname}. Please go to {$a->attemptsummaryurl} before {$a->attemptgraceend} if you would still like to submit.';
$string['emailoverduesubject'] = 'Attempt now overdue: {$a->quizpname}';
$string['empty'] = 'Empty';
...
$string['eventquizpattemptabandoned'] = 'Quiz attempt abandoned';
$string['eventquizpattempttimelimitexceeded'] = 'Quiz attempt time limit exceeded';
$string['eventquizpattemptstarted'] = 'Quiz attempt started';
$string['eventquizpattemptsubmitted'] = 'Quiz attempt submitted';
...
$string['graceperiodmin_desc'] = 'There is a potential problem right at the end of the quizp. On the one hand, we want to let students continue working right up until the last second - with the help of the timer that automatically submits the quizp when time runs out. On the other hand, the server may then be overloaded, and take some time to get to process the responses. Therefore, we will accept responses for up to this long after time expires, so they are not penalised for the server being slow. However, the student could cheat and get this many seconds to answer the quizp. You have to make a trade-off based on how much you trust the performance of your server during quizpzes.';
...
$string['grademethod_help'] = 'When multiple attempts are allowed, the following methods are available for calculating the final quizp grade:
...
$string['gradesofar'] = '{$a->method}: {$a->mygrade} / {$a->quizpgrade}.';
...
$string['guestsno'] = 'Sorry, guests cannot see or attempt quizpzes';
$string['hidebreaks'] = 'Hide page breaks';
$string['hidereordertool'] = 'Hide the reordering tool';
$string['history'] = 'History of responses:';
$string['howquestionsbehave_desc'] = 'Default setting for how questions behave in a quizp.';
...
$string['inactiveoverridehelp'] = '* Student does not have the correct group or role to attempt the quizp';
...
$string['initialnumfeedbacks_desc'] = 'When creating a new quizp, provide this many blank overall feedback boxes. Once the quizp has been created, the form shows the number of fields required for the number of feedbacks in the quizp. The setting must be at least 1.';
...
$string['invalidquizpid'] = 'Invalid quizp ID';
...
$string['link'] = 'Link';
$string['listitems'] = 'Listing of items in quizp';
...
$string['manualgradequestion'] = 'Manually grade question {$a->question} in {$a->quizp} by {$a->user}';
$string['mark'] = 'Submit';
...
$string['messageprovider:attempt_overdue'] = 'Warning when your quizp attempt becomes overdue';
$string['messageprovider:confirmation'] = 'Confirmation of your own quizp submissions';
$string['messageprovider:submission'] = 'Notification of quizp submissions';
$string['max'] = 'Max';
...
$string['modulename_help'] = 'The quizp activity enables a teacher to create quizpzes comprising questions of various types, including multiple choice, matching, short-answer and numerical.

The teacher can allow the quizp to be attempted multiple times, with the questions shuffled or randomly selected from the question bank. A time limit may be set.
...
* For self-assessment';
$string['modulename_link'] = 'mod/quizp/view';
...
$string['navmethod_help'] = 'When sequential navigation is enabled a student must progress through the quizp in order and may not return to previous pages nor skip ahead.';
...
$string['newattemptfail'] = 'Error: Could not start a new attempt at the quizp';
$string['newpage'] = 'New page';
$string['newpage_help'] = 'For longer quizpzes it makes sense to stretch the quizp over several pages by limiting the number of questions per page. When adding questions to the quizp, page breaks will automatically be inserted according to this setting. However page breaks may later be moved manually on the editing page.';
$string['newpageevery'] = 'Automatically start a new page';
$string['noanswers'] = 'No answers were selected!';
$string['noattempts'] = 'No attempts have been made on this quizp';
...
$string['nogradewarning'] = 'This quizp is not graded, so you cannot set overall feedback that differs by grade.';
$string['nomoreattempts'] = 'No more attempts are allowed';
$string['none'] = 'None';
$string['noopen'] = 'No open date';
$string['nooverridedata'] = 'You must override at least one of the quizp settings.';
...
$string['noquestionsinquizp'] = 'There are no questions in this quizp.';
...
$string['noreview'] = 'You are not allowed to review this quizp';
$string['noreviewattempt'] = 'You are not allowed to review this attempt.';
$string['noreviewshort'] = 'Not permitted';
$string['noreviewuntil'] = 'You are not allowed to review this quizp until {$a}';
$string['noreviewuntilshort'] = 'Available {$a}';
$string['noscript'] = 'JavaScript must be enabled to continue!';
$string['notavailabletostudents'] = 'Note: This quizp is not currently available to your students';
...
$string['notimedependentitems'] = 'Time dependent items are not currently supported by the quizp module. As a work around, set a time limit for the whole quizp. Do you wish to choose a different item (or use the current item regardless)?';
$string['notyetgraded'] = 'Not yet graded';
$string['notyetviewed'] = 'Not yet viewed';
$string['notyourattempt'] = 'This is not your attempt!';
$string['noview'] = 'Logged-in user is not allowed to view this quizp';
$string['numattempts'] = '{$a->studentnum} {$a->studentstring} have made {$a->attemptnum} attempts';
$string['numattemptsmade'] = '{$a} attempts made on this quizp';
$string['numberabbr'] = '#';
...
$string['orderingquizp'] = 'Order and paging';
$string['orderingquizpx'] = 'Order and paging: {$a}';
...
$string['overallfeedback_help'] = 'Overall feedback is text that is shown after a quizp has been attempted. By specifying additional grade boundaries (as a percentage or as a number), the text shown can depend on the grade obtained.';
$string['overdue'] = 'Overdue';
$string['overduehandling'] = 'When time expires';
$string['overduehandling_desc'] = 'What should happen by default if a student does not submit the quizp before time expires.';
$string['overduehandling_help'] = 'This setting controls what happens if the Student fails to submit their quizp attempt before time expires. If the student is actively working on the quizp at the time, then the countdown timer will always automatically submit the attempt for them, but if they have logged out, then this setting controls what happens.';
$string['overduehandling_link'] = 'mod/quizp/timing';
...
$string['overduemustbesubmittedby'] = 'This attempt is now overdue. It should already have been submitted. If you would like this quizp to be graded, you must submit it by {$a}. If you do not submit it by then, no marks from this attempt will be counted.';
...
$string['overridegroupeventname'] = '{$a->quizp} - {$a->group}';
$string['overrides'] = 'Overrides';
$string['overrideuser'] = 'Override user';
$string['overrideusereventname'] = '{$a->quizp} - Override';
$string['pageshort'] = 'P';
$string['page-mod-quizp-x'] = 'Any quizp module page';
$string['page-mod-quizp-attempt'] = 'Attempt quizp page';
$string['page-mod-quizp-edit'] = 'Edit quizp page';
$string['page-mod-quizp-report'] = 'Any quizp report page';
$string['page-mod-quizp-review'] = 'Review quizp attempt page';
$string['page-mod-quizp-summary'] = 'Quiz attempt summary page';
$string['page-mod-quizp-view'] = 'Quiz information page';
...
$string['popup'] = 'Show quizp in a &quot;secure&quot; window';
$string['popupblockerwarning'] = 'This section of the test is in secure mode, this means that you need to take the quizp in a secure window. Please turn off your popup blocker. Thank you.';
$string['popupnotice'] = 'Students will see this quizp in a secure window';
$string['preprocesserror'] = 'Error occurred during pre-processing!';
$string['preview'] = 'Preview';
$string['previewquestion'] = 'Preview question';
$string['previewquizp'] = 'Preview {$a}';
$string['previewquizpnow'] = 'Preview quizp now';
...
$string['questioninuse'] = 'The question \'{$a->questionname}\' is currently being used in: <br />{$a->quizpnames}<br />The question will not be deleted from these quizpzes but only from the category list.';
...
$string['questionsinthisquizp'] = 'Questions in this quizp';
...
$string['quizp:addinstance'] = 'Add a new quizp';
$string['quizp:attempt'] = 'Attempt quizpzes';
$string['quizpavailable'] = 'The quizp is available until: {$a}';
$string['quizpclose'] = 'Close the quizp';
$string['quizpclosed'] = 'This quizp closed on {$a}';
$string['quizpcloses'] = 'Quiz closes';
$string['quizpcloseson'] = 'This quizp will close at {$a}';
$string['quizp:deleteattempts'] = 'Delete quizp attempts';
$string['quizp:emailconfirmsubmission'] = 'Get a confirmation message when submitting';
$string['quizp:emailnotifysubmission'] = 'Get a notification message when an attempt is submitted';
$string['quizp:emailwarnoverdue'] = 'Get a notification message when an attempt becomes overdue and needs to be submitted.';
$string['quizp:grade'] = 'Grade quizpzes manually';
$string['quizp:ignoretimelimits'] = 'Ignores time limit on quizpzes';
$string['quizpisclosed'] = 'This quizp is closed';
$string['quizpisopen'] = 'This quizp is open';
$string['quizpisclosedwillopen'] = 'Quiz closed (opens {$a})';
$string['quizpisopenwillclose'] = 'Quiz open (closes {$a})';
$string['quizp:manage'] = 'Manage quizpzes';
$string['quizp:manageoverrides'] = 'Manage quizp overrides';
$string['quizpnavigation'] = 'Quiz navigation';
$string['quizpopen'] = 'Open the quizp';
$string['quizpopenclose'] = 'Open and close dates';
$string['quizpopenclose_help'] = 'Students can only start their attempt(s) after the open time and they must complete their attempts before the close time.';
$string['quizpopenclose_link'] = 'mod/quizp/timing';
$string['quizpopened'] = 'This quizp is open.';
$string['quizpopenedon'] = 'This quizp opened at {$a}';
$string['quizpopens'] = 'Quiz opens';
$string['quizpopenwillclose'] = 'This quizp is open, will close on {$a} at';
$string['quizpordernotrandom'] = 'Order of quizp not shuffled';
$string['quizporderrandom'] = '* Order of quizp is shuffled';
$string['quizp:preview'] = 'Preview quizpzes';
$string['quizp:regrade'] = 'Regrade quizp attempts';
$string['quizp:reviewmyattempts'] = 'Review your own attempts';
$string['quizpsettings'] = 'Quiz settings';
$string['quizp:view'] = 'View quizp information';
$string['quizp:viewreports'] = 'View quizp reports';
$string['quizptimer'] = 'Quiz Timer';
$string['quizpwillopen'] = 'This quizp will open {$a}';
...
$string['readytosend'] = 'You are about to send your whole quizp to be graded.  Are you sure you want to continue?';
$string['reattemptquizp'] = 'Re-attempt quizp';
...
$string['regradenotallowed'] = 'You do not have permission to regrade this quizp';
$string['regradingquestion'] = 'Regrading "{$a}".';
$string['regradingquizp'] = 'Regrading quizp "{$a}"';
$string['remove'] = 'Remove';
$string['removeallgroupoverrides'] = 'Delete all group overrides';
$string['removeallquizpattempts'] = 'Delete all quizp attempts';
...
$string['reportusersall'] = 'all users who have attempted the quizp';
$string['reportuserswith'] = 'enrolled users who have attempted the quizp';
$string['reportuserswithorwithout'] = 'enrolled users who have, or have not, attempted the quizp';
$string['reportuserswithout'] = 'enrolled users who have not attempted the quizp';
$string['reportwhattoinclude'] = 'What to include in the report';
$string['requirepassword'] = 'Require password';
$string['requirepassword_help'] = 'If a password is specified, a student must enter it in order to attempt the quizp.';
$string['requiresubnet'] = 'Require network address';
$string['requiresubnet_help'] = 'Quiz access may be restricted to particular subnets on the LAN or Internet by specifying a comma-separated list of partial or full IP address numbers. This can be useful for an invigilated (proctored) quizp, to ensure that only people in a certain location can access the quizp.';
$string['response'] = 'Response';
$string['responses'] = 'Responses';
$string['results'] = 'Results';
$string['returnattempt'] = 'Return to attempt';
$string['reuseifpossible'] = 'reuse previously removed';
$string['reverttodefaults'] = 'Revert to quizp defaults';
$string['review'] = 'Review';
$string['reviewafter'] = 'Allow review after quizp is closed';
$string['reviewalways'] = 'Allow review at any time';
$string['reviewattempt'] = 'Review attempt';
$string['reviewbefore'] = 'Allow review while quizp is open';
$string['reviewclosed'] = 'After the quizp is closed';
...
$string['reviewofquestion'] = 'Review of question {$a->question} in {$a->quizp} by {$a->user}';
$string['reviewopen'] = 'Later, while the quizp is still open';
$string['reviewoptions'] = 'Students may review';
$string['reviewoptionsheading'] = 'Review options';
$string['reviewoptionsheading_help'] = 'These options control what information students can see when they review a quizp attempt or look at the quizp reports.
...
**Later, while the quizp is still open** settings apply after this, and before the quizp close date.

**After the quizp is closed** settings apply after the quizp close date has passed. If the quizp does not have a close date, this state is never reached.';
...
$string['saveattemptfailed'] = 'Failed to save the current quizp attempt.';
...
$string['savequizp'] = 'Save this whole quizp';
...
$string['showblocks'] = 'Show blocks during quizp attempts';
$string['showblocks_help'] = 'If set to yes then normal blocks will be shown during quizp attempts';
...
$string['shufflequestions_help'] = 'If you turn this on, then every time the quizp is attempted, the order of the questions in this section will be shuffled into a different random order.
...
$string['shufflewithin_help'] = 'If enabled, the parts making up each question will be randomly shuffled each time a student attempts the quizp, provided the option is also enabled in the question settings. This setting only applies to questions that have multiple parts, such as multiple choice or matching questions.';
...
$string['specificquestionnotonquizp'] = 'Specified question is not on the specified quizp';
...
$string['subneterror'] = 'Sorry, this quizp has been locked so that it is only accessible from certain locations.  Currently your computer is not one of those allowed to use this quizp.';
$string['subnetnotice'] = 'This quizp has been locked so that it is only accessible from certain locations. Your computer is not on an allowed subnet. As teacher you are allowed to preview anyway.';
$string['subplugintype_quizp'] = 'Report';
$string['subplugintype_quizp_plural'] = 'Reports';
$string['subplugintype_quizpaccess'] = 'Access rule';
$string['subplugintype_quizpaccess_plural'] = 'Access rules';
...
$string['temporaryblocked'] = 'You are temporarily not allowed to re-attempt the quizp.<br /> You will be able to take another attempt on:';
$string['theattempt'] = 'The attempt';
$string['theattempt_help'] = 'Whether the student can review the attempt at all.';
$string['time'] = 'Time';
$string['timecompleted'] = 'Completed';
$string['timedelay'] = 'You are not allowed to do the quizp since you have not passed the time delay before attempting another quizp';
$string['timeleft'] = 'Time left';
$string['timelimit'] = 'Time limit';
$string['timelimit_help'] = 'If enabled, the time limit is stated on the initial quizp page and a countdown timer is displayed in the quizp navigation block.';
$string['timelimit_link'] = 'mod/quizp/timing';
...
$string['updatesettings'] = 'Update quizp settings';
...
$string['upgradesure'] = '<div>In particular the quizp module will perform an extensive change of the quizp tables and this upgrade has not yet been sufficiently tested. You are very strongly urged to backup your database tables before proceeding.</div>';
$string['upgradingquizpattempts'] = 'Upgrading quizp attempts: quizp {$a->done}/{$a->outof} (Quiz id {$a->info})';
$string['upgradingveryoldquizpattempts'] = 'Upgrading very old quizp attempts: {$a->done}/{$a->outof}';
$string['url'] = 'URL';
...
$string['usersnone'] = 'No students have access to this quizp';
$string['validate'] = 'Validate';
$string['viewallanswers'] = 'View {$a} quizp attempts';
...
$string['xhtml'] = 'XHTML';
$string['youneedtoenrol'] = 'You need to enrol in this course before you can attempt this quizp';
$string['yourfinalgradeis'] = 'Your final grade for this quizp is {$a}.';
