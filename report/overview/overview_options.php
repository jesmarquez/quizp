...
/**
 * Class to store the options for a {@link quizp_overview_report}.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizp_overview_options extends mod_quizp_attempts_report_options {
    ...
    public function setup_from_user_preferences() {
        ...
        $this->slotmarks = get_user_preferences('quizp_overview_slotmarks', $this->slotmarks);
    }

    public function update_user_preferences() {
        parent::update_user_preferences();

        if (quizp_has_grades($this->quizp)) {
            set_user_preference('quizp_overview_slotmarks', $this->slotmarks);
        }
    }
    ...
    public function resolve_dependencies() {
        ...
        $this->checkboxcolumn = has_any_capability(
                array('mod/quizp:regrade', 'mod/quizp:deleteattempts'), context_module::instance($this->cm->id))
