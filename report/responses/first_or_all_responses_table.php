...
/**
 * This file defines the quizp responses table for showing first or all tries at a question.
 *
...
/**
 * This is a table subclass for displaying the quizp responses report, showing first or all tries.
 *
 * @package   quizp_responses
 * @copyright 2014 The Open University
 * @author    Jamie Pratt <me@jamiep.org>
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizp_first_or_all_responses_table extends quizp_last_responses_table {
        ...
        foreach ($this->rawdata as $attempt) {
            ...
            for ($try = 1; $try <= $maxtriesinanyslot; $try++) {
                ...
                if ($try !== $maxtriesinanyslot) {
                    $newtablerow->state = quizp_attempt::IN_PROGRESS;
                }
                $newtablerow->try = $try;
