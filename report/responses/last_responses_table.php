...
/**
 * This file defines the quizp responses table for showing last try at question.
 *
...
/**
 * This is a table subclass for displaying the quizp responses report.
 *
 * @copyright 2008 Jean-Michel Vedrine
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class quizp_last_responses_table extends quizp_attempts_report_table {
     ...
     * @param quizp_responses_options $options
     * @param array $groupstudents
     * @param array $students
     * @param array $questions
     * @param moodle_url $reporturl
     */
    public function __construct($quizp, $context, $qmsubselect, quizp_responses_options $options,
            $groupstudents, $students, $questions, $reporturl) {
        parent::__construct('mod-quizp-report-responses-report', $quizp, $context,
    ...
    public function col_sumgrades($attempt) {
        ...
        $gradehtml = '<a href="review.php?q=' . $this->quizp->id . '&amp;attempt=' .
