...
/**
 * Strings for component 'quizp_statistics', language 'en', branch 'MOODLE_20_STABLE'
 *
...
$string['backtoquizpreport'] = 'Back to main statistics report page.';
$string['calculatefrom'] = 'Calculate statistics from';
$string['calculatingallstats'] = 'Calculating statistics for quizp, questions and analysing response data';
...
$string['errorpowers'] = 'Error fetching data to calculate variance for quizp grades';
...
$string['negcovar_help'] = 'This question\'s grade for this set of attempts on the quizp varies in an opposite way to the overall attempt grade. This means overall attempt grade tends to be below average when the grade for this question is above average and vice-versa.
...
If you edit a quizp and give these question(s) with negative covariance a max grade of zero then the effective question weight of these questions will be zero and the real effective question weight of other questions will be as calculated now.';
...
$string['quizpinformation'] = 'Quiz information';
$string['quizpname'] = 'Quiz name';
$string['quizpoverallstatistics'] = 'Quiz overall statistics';
$string['quizpstructureanalysis'] = 'Quiz structure analysis';
