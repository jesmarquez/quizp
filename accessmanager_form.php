...
/**
 * Defines the form that limits student's access to attempt a quizp.
 *
 * @package   mod_quizp
...
/**
 * A form that limits student's access to attempt a quizp.
 *
 * @copyright  2011 The Open University
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class mod_quizp_preflight_check_form extends moodleform {
