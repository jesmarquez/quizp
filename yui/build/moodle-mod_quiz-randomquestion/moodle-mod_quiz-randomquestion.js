YUI.add('moodle-mod_quizp-randomquestion', function (Y, NAME) {
...
/**
 * Add a random question functionality for a popup in quizp editing page.
 *
 * @package   mod_quizp
...
M.mod_quizp.randomquestion = M.mod_quizp.randomquestion || {};
M.mod_quizp.randomquestion.init = function() {
    return new POPUP();
};
