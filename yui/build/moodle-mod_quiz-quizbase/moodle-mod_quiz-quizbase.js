YUI.add('moodle-mod_quizp-quizpbase', function (Y, NAME) {

/**
 * The quizpbase class to provide shared functionality to Modules within Moodle.
 *
 * @module moodle-mod_quizp-quizpbase
 */
var QUIZPBASENAME = 'mod_quizp-quizpbase';

var QUIZPBASE = function() {
    QUIZPBASE.superclass.constructor.apply(this, arguments);
};
...
M.mod_quizp.quizpbase = M.mod_quizp.quizpbase || new QUIZPBASE();

// Abstract functions that needs to be defined per format (course/format/somename/format.js)
M.mod_quizp.edit = M.mod_quizp.edit || {};
 ...
 */
M.mod_quizp.edit.swap_sections = function(Y, node1, node2) {
    var CSS = {
 ...
 * @return void
 */
M.mod_quizp.edit.process_sections = function(Y, sectionlist, response, sectionfrom, sectionto) {
    var CSS = {
