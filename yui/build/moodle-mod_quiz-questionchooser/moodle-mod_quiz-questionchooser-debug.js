YUI.add('moodle-mod_quizp-questionchooser', function (Y, NAME) {
...
Y.extend(QUESTIONCHOOSER, M.core.chooserdialogue, {
    ...
    NAME: 'mod_quizp-questionchooser'
});

M.mod_quizp = M.mod_quizp || {};
M.mod_quizp.init_questionchooser = function() {
    M.mod_quizp.question_chooser = new QUESTIONCHOOSER({});
    return M.mod_quizp.question_chooser;
};


}, '@VERSION@', {"requires": ["moodle-core-chooserdialogue", "moodle-mod_quizp-util", "querystring-parse"]});
