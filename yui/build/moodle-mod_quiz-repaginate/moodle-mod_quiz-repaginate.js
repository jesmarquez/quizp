YUI.add('moodle-mod_quizp-repaginate', function (Y, NAME) {
...
/**
 * Repaginate functionality for a popup in quizp editing page.
 *
 * @package   mod_quizp
...
M.mod_quizp.repaginate = M.mod_quizp.repaginate || {};
M.mod_quizp.repaginate.init = function() {
    return new POPUP();
};
